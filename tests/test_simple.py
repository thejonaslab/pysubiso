...
def test_c_is_subiso_1():
    ...
    m = pysubiso.create_match('RI')
    assert m.is_indsubiso(x, c, x, c, 1.0)
...
#     y[0, 1] = 1
#     y = y + y.T
#     assert pysubiso.c_is_subiso(y, c, x, c, 1.0)
#     assert not pysubiso.c_is_subiso(x, c, y, c, 1.0)
...
#     assert pysubiso.c_is_subiso(sub_adj, c_sub, main_adj, c_main, 1.0)
#     assert not pysubiso.c_is_subiso(main_adj, c_main, sub_adj, c_sub, 1.0)
